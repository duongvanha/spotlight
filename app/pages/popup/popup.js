...
window.failbackSearchSuggestion = null
...
function rerenderSuggestions(event) {
  ...
  if (domain) {
    ...
    if (matches.length) {
      ...
      if (window.failbackSearchSuggestion && window.failbackSearchSuggestion.failBack && failbackSearchSuggestion.searchScope.toUpperCase() === domain.toUpperCase()) {
        utils.renderSuggestions(window.failbackSearchSuggestion.failBack(query))
      }
    }
  } else {
